...
func (o *Event) MarshalROOT(w *rbytes.WBuffer) (int, error) {
	...
	w.WriteObjectAny(o.ObjStr) // obj-ptr
	...
	for i := range o.ArrayP3s {
		o.ArrayP3s[i].MarshalROOT(w) // obj-any
	}
	for i := range o.ArrayObjStr {
		o.ArrayObjStr[i].MarshalROOT(w) // obj
	}
...
func (o *Event) UnmarshalROOT(r *rbytes.RBuffer) error {
	...
	for i := range o.ArrayP3s {
		o.ArrayP3s[i].UnmarshalROOT(r) // obj-any
	}
	for i := range o.ArrayObjStr {
		o.ArrayObjStr[i].UnmarshalROOT(r) // obj
	}
	o.N = r.ReadI32()
	_ = r.ReadI8() // is-array
...
func init() {
	// Streamer for Event.
	rdict.Streamers.Add(rdict.NewCxxStreamerInfo("Event", 1, 0xd0d2f42, []rbytes.StreamerElement{
...
func init() {
	// Streamer for P3.
	rdict.Streamers.Add(rdict.NewCxxStreamerInfo("P3", 1, 0x64044917, []rbytes.StreamerElement{
		&rdict.StreamerBasicType{StreamerElement: rdict.Element{
